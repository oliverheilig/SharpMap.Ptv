...
namespace Ptv.Controls.Map
{
    public class InteractiveLayer : Layer
    {
        ...
        public InteractiveLayer(string layername)
        {
        ...
        public InteractiveLayer(string layername, SharpMap.Data.Providers.IProvider dataSource)
            : this(layername)
        {
        ...
        /// </summary>
        public SharpMap.Styles.VectorStyle Style
        {
            get { return _Style; }
            set { _Style = value; }
        }
